...
public class ObservableRangeCollection<T> : ObservableCollection<T>
{
    ...
    /// <summary>
    ///     Initializes a new instance of the System.Collections.ObjectModel.ObservableRangeCollection(Of T) class that
    ...
    public void UpdateRowIndex()
    {
        try
        {
            ...
            foreach (var item in Items) pr.SetValue(item, Items.IndexOf(item) + 1, null);
            UpdateSource();
        }
        catch
        {
...
public static class ObservableCollectionExtension
{
    ...
    public static ObservableRangeCollection<TSource> OrderByEx<TSource, TKey>(
        this ObservableRangeCollection<TSource> source
