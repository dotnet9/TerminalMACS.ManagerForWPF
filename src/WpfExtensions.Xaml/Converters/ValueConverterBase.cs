...
public abstract class ValueConverterBase<TSource, TTarget, TParameter> : IValueConverter
{
    ...
    protected virtual TTarget ConvertNonNullValue(TSource value, TParameter parameter)
    {
    ...
    protected virtual TSource ConvertBack(TTarget value, TParameter parameter)
    {
        throw new NotSupportedException();
    }
}
...
{
    protected sealed override TTarget Convert(TSource value, object parameter)
    {
        return Convert(value);
    }

    protected sealed override TSource ConvertBack(TTarget value, object parameter)
    {
        return ConvertBack(value);
    }

    protected virtual TTarget ConvertNonNullValue(TSource value)
    {
        throw new NotSupportedException();
    }
    ...
    {
        return value != null ? ConvertNonNullValue(value) : default;
    }
